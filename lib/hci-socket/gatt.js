    ...
    if (opcode === ATT_OP_READ_BY_TYPE_RESP) {
      ...
      try {
        value = data.readUInt16LE(4);
          ...
          /* The data we received was somehow truncted so that we could
           * not read a 16 bit integer. This occurs when talking to an ESP32
           * esp-mesh mconfig-blufi system. By returning we avoid
